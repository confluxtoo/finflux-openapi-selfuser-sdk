package co.finflux.openapi.self.infrastructure

import co.finflux.openapi.self.auth.HttpBearerAuth
...
class ApiClient(
    ...
    companion object {
        ...
        val defaultBasePath: String by lazy {
            System.getProperties().getProperty("co.finflux.openapi.self.baseUrl", "https://develop.finflux.io/fineract-provider/api")
        }
    }
}
